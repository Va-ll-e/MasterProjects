...
{
    [Serializable]
    public class TransitionMsg : Message
    {
        public const string k_RosMessageName = "lifecycle_msgs/Transition";
        ...
        public TransitionMsg()
        {
            this.id = 0;
            this.label = "";
        }

        public TransitionMsg(byte id, string label)
        {
            this.id = id;
            this.label = label;
        }

        public static TransitionMsg Deserialize(MessageDeserializer deserializer) => new TransitionMsg(deserializer);

        private TransitionMsg(MessageDeserializer deserializer)
        {
